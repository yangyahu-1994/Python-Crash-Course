...
print("Dear " + popped_person_2.title() + "," + " I am sorry that I cannot invite you to dinner.")
popped_person_3 = invited_persons.pop(1)
print("Dear " + popped_person_3.title() + "," + " I am sorry that I cannot invite you to dinner.")
popped_person_4 = invited_persons.pop(2)
print("Dear " + popped_person_4.title() + "," + " I am sorry that I cannot invite you to dinner.")
popped_person_5 = invited_persons.pop(1)
print("Dear " + popped_person_5.title() + "," + " I am sorry that I cannot invite you to dinner.")

# 告知余下的两位
print("\nDear " + invited_persons[0].title() + "," + " you are still among the invitees.")
print("Dear " + invited_persons[1].title() + "," + " you are still among the invitees.")
